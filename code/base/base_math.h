...
// typedef Vec3F32 Vec3F32;
// typedef Vec4F32 Vec4F32;
...
function Vec2F32 Add2F32(Vec2F32 a, Vec2F32 b);
function Vec2F32 Sub2F32(Vec2F32 a, Vec2F32 b);
function Vec2F32 Mul2F32(Vec2F32 a, Vec2F32 b);
function Vec2F32 Div2F32(Vec2F32 a, Vec2F32 b);
function Vec2F32 Scale2F32(Vec2F32 a, F32 scale);
function F32 Dot2F32(Vec2F32 a, Vec2F32 b);
function F32 LengthSquared2F32(Vec2F32 v);
function F32 Length2F32(Vec2F32 v);
function Vec2F32 Normalize2F32(Vec2F32 v);
function Vec2F32 Mix2F32(Vec2F32 a, Vec2F32 b, F32 t);

function Vec2S32 V2S32(S32 x, S32 y);

function Vec3F32 V3F32(F32 x, F32 y, F32 z);
function Vec3F32 Add3F32(Vec3F32 a, Vec3F32 b);
function Vec3F32 Sub3F32(Vec3F32 a, Vec3F32 b);
function Vec3F32 Mul3F32(Vec3F32 a, Vec3F32 b);
function Vec3F32 Div3F32(Vec3F32 a, Vec3F32 b);
function Vec3F32 Scale3F32(Vec3F32 a, F32 scale);
function F32 Dot3F32(Vec3F32 a, Vec3F32 b);
function F32 LengthSquared3F32(Vec3F32 v);
function F32 Length3F32(Vec3F32 v);
function Vec3F32 Normalize3F32(Vec3F32 v);
function Vec3F32 Mix3F32(Vec3F32 a, Vec3F32 b, F32 t);
function Vec3F32 Cross3F32(Vec3F32 a, Vec3F32 b);

function Vec4F32 V4F32(F32 x, F32 y, F32 z, F32 w);
function Vec4F32 Add4F32(Vec4F32 a, Vec4F32 b);
function Vec4F32 Sub4F32(Vec4F32 a, Vec4F32 b);
function Vec4F32 Mul4F32(Vec4F32 a, Vec4F32 b);
function Vec4F32 Div4F32(Vec4F32 a, Vec4F32 b);
function Vec4F32 Scale4F32(Vec4F32 a, F32 scale);
function F32 Dot4F32(Vec4F32 a, Vec4F32 b);
function F32 LengthSquared4F32(Vec4F32 v);
function F32 Length4F32(Vec4F32 v);
function Vec4F32 Normalize4F32(Vec4F32 v);
function Vec4F32 Mix4F32(Vec4F32 a, Vec4F32 b, F32 t);
function Vec4F32 Transform4F32(Vec4F32 v, Matrix4x4F32 m);
...
function Rng2F32 R2F32(Vec2F32 min, Vec2F32 max);
function Rng2F32 Shift2F32(Rng2F32 r, Vec2F32 v);
function Rng2F32 Pad2F32(Rng2F32 r, F32 x);
function Vec2F32 Center2F32(Rng2F32 r);
function B32 Contains2F32(Rng2F32 r, Vec2F32 v);
function Vec2F32 Dim2F32(Rng2F32 r);
...
function Matrix3x3F32 MakeMatrix3x3F32(F32 d);
function Matrix3x3F32 MakeTranslate3x3F32(Vec2F32 translation);
function Matrix3x3F32 MakeScale3x3F32(Vec2F32 scale);
function Matrix3x3F32 MakeRotate3x3(F32 angle);

function Matrix4x4F32 MakeMatrix4x4F32(F32 d);
function Matrix4x4F32 MakeTranslate4x4F32(Vec3F32 translation);
function Matrix4x4F32 MakeScale4x4F32(Vec3F32 scale);
function Matrix4x4F32 MakePerspective4x4F32(F32 fov, F32 aspect_ratio, F32 near_z, F32 far_z);
function Matrix4x4F32 MakeLookAt4x4F32(Vec3F32 eye, Vec3F32 center, Vec3F32 up);

//~ rjf: Matrix Ops

function Matrix3x3F32 Mul3x3F32(Matrix3x3F32 a, Matrix3x3F32 b);
function Matrix3x3F32 Scale3x3F32(Matrix3x3F32 m, F32 scale);
function Matrix4x4F32 Scale4x4F32(Matrix4x4F32 m, F32 scale);
function Matrix4x4F32 Mul4x4F32(Matrix4x4F32 a, Matrix4x4F32 b);
function Matrix4x4F32 Inverse4x4F32(Matrix4x4F32 m);
function Matrix4x4F32 RemoveRotation4x4F32(Matrix4x4F32 mat);

//~ rjf: Miscellaneous Ops

function Vec3F32 HSVFromRGB(Vec3F32 rgb);
function Vec3F32 RGBFromHSV(Vec3F32 hsv);
function Vec4F32 Vec4F32FromHexRGBA(U32 hex);
